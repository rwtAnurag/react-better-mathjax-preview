...
var MathPreview = /*#__PURE__*/function (_Component) {
  _inherits(MathPreview, _Component);
  var _super = _createSuper(MathPreview);
  function MathPreview(props) {
    var _this;
    _classCallCheck(this, MathPreview);
...
_defineProperty(MathPreview, "propTypes", {
  className: _propTypes["default"].string,
  style: _propTypes["default"].string,
  math: _propTypes["default"].string
});
_defineProperty(MathPreview, "defaultProps", {
  math: ''
});
var _default = /*#__PURE__*/_react["default"].memo(MathPreview);
